...
public class PostController {
	...
	@PostMapping("/{idPost}/upload")
	public ResponseEntity uploadPhotoPost(@RequestHeader("Authorization") String token,
										  @PathVariable UUID idPost,
		...
		try {
			...
			postService.uploadPhotoPost(photo, idHeaders, idPost);
